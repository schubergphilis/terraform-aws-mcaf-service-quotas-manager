...
| <a name="input_role_name"></a> [role\_name](#input\_role\_name) | Name of the IAM role used for the ServiceQuotasManager | `string` | `"ServiceQuotasManagerRole"` | no |
| <a name="input_role_path"></a> [role\_path](#input\_role\_path) | Namespaced IAM role path used when constructing the ServiceQuotasManagerRole ARN | `string` | `"/"` | no |
